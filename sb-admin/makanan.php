...
<body class="sb-nav-fixed">
  <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    <!-- Navbar Brand-->
    <a class="navbar-brand ps-5" href="index.html"><i class="fa-brands fa-shopify text-danger"></i> MDS</a>
    <!-- Sidebar Toggle-->
    ...
    <ul class="navbar-nav ms-auto">
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
          ...
          <li><a class="dropdown-item" href="logout.php" onclick="return confirm('Apakah anda yakin ingi keluar?')">Logout</a></li>
        </ul>
      </li>
    </ul>
  </nav>
          ...
          <div class="container">
            <div class="row">
              <div class="col-md-6 mb-3">
                <h1>Selamat berbelanja <i class="fa-solid fa-face-smile-wink text-primary"></i></h1>
              </div>
